...
function Post({postId, user, userImg, username, postImg, caption, curTime}){
    ...
    if (show) {
        ...
        button = <button onClick={moreCaption}>{"more"}</button>;
    }
            ...
            <div className="Post">
                <header>
                    <div className="HeaderUserImg">
                        <img alt="" class="_6q-tv" width="32" height="32" data-testid="user-avatar" draggable="false" src={userImg}/>
                    </div>                        
                ...
                <div className="PostImg">
                    <img alt="" class="FFVAD" decoding="auto" sizes="614px" draggable="false" src={postImg} />                
                </div>
...
//         }
//         else {
//             button = <button onClick={this.moreCaption}>{"more"}</button>
//         }
