...
function Post({postId, user, userImg, username, postImg, caption, likes, likeNum, count, createdTime}){
    ...
    return(
            <div className="Post">
                ...
                <div className="PostImg">
                    <img alt="" decoding="auto" sizes="614px" draggable="false" src={postImg} />                
                </div>
